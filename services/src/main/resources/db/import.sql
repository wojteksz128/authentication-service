...
------------------------------------------------------------------------------------------------------------------------
INSERT INTO user_roles ( SELECT u.id, r.id FROM users u, roles r WHERE u.login = 'dev@t.t' );
INSERT INTO user_roles ( SELECT u.id, r.id FROM users u, roles r WHERE u.login = 'user@t.t' AND r.code = 'USER' );
INSERT INTO user_roles ( SELECT u.id, r.id FROM users u, roles r WHERE u.login = 'wojteksz128@o2.pl' AND r.code = 'USER' );
